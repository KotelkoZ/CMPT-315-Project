...
function makeTable(){
    ...
    google.setOnLoadCallback(drawTable);
        ...
        data.addColumn('string', 'Attribute');
          /*for(var i = 0;i < document.getElementById('combo').length;i++){
              data.addRow('string', document.getElementById('combo').value);
          }*/
        ...
        var table = new google.visualization.Table(document.getElementById('stock_compare_table'));
        table.draw(data, {});
